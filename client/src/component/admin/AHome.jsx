...
function AHome() {
  const { pendingLeave,setPendingLeave,setMydetail,activeProjects,TodayAttendance,setActiveProjects,allEmployeesData, setAllEmployeesData,loading,setLoading,projects, setProjects, employeeData, teamMembers, setTeamMembers, teamMembersData, setTeamMembersData,setTodayAttendance } = useContext(EmployeeContext)
  ...
  console.log("all employee length" , allEmployeesData.length)
  console.log("today length" , TodayAttendance.length)
    ...
    <div>
      ...
      :(
        ...
        <div className='thome_div1'>
          ...
          <div className='thome_div11 third' onClick={()=>{navigate('/admin/newemployee')}}>
            <div className='thome_div111'>
              New Employee
            </div>
            <div className='thome_div112'>
