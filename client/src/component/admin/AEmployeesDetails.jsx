...
function AEmployeesDetails() {
  const { teamMembersData,allEmployeesData }=useContext(EmployeeContext)
...
useEffect(() => {
    const employeesOnly = allEmployeesData.filter((employee) => employee.position === "employee");
...
export default AEmployeesDetails