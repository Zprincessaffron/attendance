...
import DatePickerComponent from '../teamLead/DatePickerComponent';
function ATodayAttendance() {
...
console.log("TodayAttendance",TodayAttendance.length)
      ...
      <table className="custom-table">
        ...
        <tbody>
          {TodayAttendance.length > 0 ? (
            ...
            <tr key={index}>
              <td>{index+1}</td>
              <td data-tooltip-id="my-tooltip" data-tooltip-content={item.name}>{item.employeeId}</td>
...
export default ATodayAttendance