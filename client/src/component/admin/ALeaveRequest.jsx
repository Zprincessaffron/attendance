...
function ALeaveRequest() {
  const { TodayAttendance, setTodayAttendance,allEmployeesData, setAttendanceData, AttendanceData, employeeData, teamMembers } = useContext(EmployeeContext)
